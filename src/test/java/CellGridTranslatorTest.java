...
//        CellGrid cellGrid = new CellGrid(3,3);
//
//        cellGrid.setCellStateAsAlive(1,1);
//
...
//        CellGrid cellGrid = new CellGrid(3,3);
//
//        cellGrid.setCellStateAsAlive(0,0);
//        cellGrid.setCellStateAsAlive(0,1);
//        cellGrid.setCellStateAsAlive(0,2);
//        cellGrid.setCellStateAsAlive(1,0);
//        cellGrid.setCellStateAsAlive(1,1);
//        cellGrid.setCellStateAsAlive(1,2);
//        cellGrid.setCellStateAsAlive(2,0);
//        cellGrid.setCellStateAsAlive(2,1);
//
